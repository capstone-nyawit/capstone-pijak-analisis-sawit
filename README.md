...
3.  Jalankan aplikasi backend:
    ...
    python main.py
    ```
    _Backend lokal berjalan di `http://localhost:8000`._
...
_Frontend lokal berjalan di `http://localhost:5173`._
...
2.  **`/users`**: Manajemen profil, perubahan kata sandi, pergantian alamat email, serta persetujuan (_approval_) staf baru oleh admin.
...
_(Akan muncul konfirmasi prompt keamanan sebelum database dihapus)_
