...
import { Target, Users, Droplets } from 'lucide-react';
    ...
    return (
        <section id="features" className="py-24 relative overflow-hidden">
            ...
            <div className="mx-auto max-w-3xl lg:max-w-6xl px-6 relative z-10">
                ...
                >
                    <h2 className="text-[#4ade80] font-semibold text-xs uppercase tracking-[0.3em] mb-4">Core Technology</h2>
                    <h3 className="text-4xl sm:text-5xl font-semibold text-[#F8FAF6] tracking-tight leading-tight">Intelligence for the <br /> <span className="text-[#d97706] font-light italic">Modern Estate.</span></h3>
                </motion.div>
                            ...
                            <Card className="relative w-full flex overflow-hidden !bg-white/[0.02] backdrop-blur-3xl !border-white/[0.06] shadow-[inset_0_1px_3px_rgba(255,255,255,0.1),_0_8px_32px_rgba(0,0,0,0.3)] hover:!bg-white/[0.05] hover:!border-white/[0.12] transition-all duration-500 group">
                                <CardContent className="relative m-auto size-fit pt-8 pb-6 flex flex-col items-center justify-center">
                                    <div className="relative flex h-24 w-56 items-center justify-center">
                                        ...
                                        <span className="mx-auto block w-fit text-5xl font-semibold text-[#F8FAF6]">99.4<span className="text-3xl font-light">%</span></span>
                                    </div>
                                    <h2 className="mt-8 text-center text-xl font-semibold tracking-tight text-[#F8FAF6]">Object Detection</h2>
                                    <p className="mt-3 text-center text-sm font-light text-white/60">Pinpoint every crown with Faster R-CNN accuracy.</p>
                                </CardContent>
                            </Card>
                        </motion.div>
                                ...
                                <CardContent className="pt-8 flex flex-col h-full">
                                    <div className="relative mx-auto flex aspect-square size-32 rounded-full border border-white/[0.03] bg-white/[0.02] shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)] flex-col justify-center items-center">
                                        <svg className="m-auto h-fit w-20 text-[#4ade80]" viewBox="0 0 212 143" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <path className="text-[#4ade80]" d="M3 72H209" stroke="currentColor" strokeWidth="6" strokeLinecap="round" />
                                            <defs>
                                                <linearGradient id="paint0_linear_0_1" x1="106.385" y1="1.34375" x2="106" y2="72" gradientUnits="userSpaceOnUse">
                                                    <stop stopColor="white" stopOpacity="0" />
                                                    <stop className="text-[#4ade80]" offset="1" stopColor="currentColor" />
                                                </linearGradient>
                                    ...
                                    <div className="relative z-10 mt-6 space-y-2 text-center flex-1">
                                        <h2 className="text-xl font-semibold text-[#F8FAF6]">Tree Health Analytics</h2>
                                        <p className="text-white/60 font-light text-sm">Categorize plantations by 4-Tier health levels: Healthy, Stunted, Deficient, or Terminal.</p>
                                    </div>
                                </CardContent>
                            </Card>
                        </motion.div>
                        ...
                        >
                            <Card className="relative h-full overflow-hidden !bg-white/[0.02] backdrop-blur-3xl !border-white/[0.06] shadow-[inset_0_1px_3px_rgba(255,255,255,0.1),_0_8px_32px_rgba(0,0,0,0.3)] hover:!bg-white/[0.05] hover:!border-white/[0.12] transition-all duration-500 group">
                                <CardContent className="pt-6 flex flex-col h-full">
                                    ...
                                    <div className="relative z-10 mt-14 space-y-2 text-center flex-1">
                                        <h2 className="text-xl font-semibold text-[#F8FAF6]">Sub-3s Fast Analysis</h2>
                                        <p className="text-white/60 font-light text-sm">Process large drone orthomosaics instantly and accurately.</p>
                                    </div>
                                </CardContent>
                            </Card>
                        </motion.div>
                                ...
                                <CardContent className="grid h-full pt-8 sm:grid-cols-2 gap-8">
                                    <div className="relative z-10 flex flex-col justify-center space-y-6">
                                        ...
                                        <div className="space-y-3">
                                            <h2 className="text-2xl font-semibold text-[#F8FAF6]">VRA Optimization</h2>
                                            <p className="text-white/60 font-light text-sm leading-relaxed">Generate fertilization maps for Variable Rate Application hardware, reducing chemical waste by up to 22%.</p>
                                        </div>
                                    </div>
                                    <div className="relative bg-white/[0.02] rounded-3xl p-6 border border-white/[0.03] shadow-[inset_0_1px_1px_rgba(255,255,255,0.02)] flex items-center justify-center min-h-[200px]">
                                        <Droplets className="size-24 text-white/5 absolute" />
                                        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(74,222,128,0.05),transparent_70%)]" />
                                        <div className="z-10 bg-[#011712]/50 backdrop-blur-md p-4 rounded-2xl shadow-sm border border-white/[0.05] flex items-center gap-3">
                                            <div className="w-2.5 h-2.5 bg-[#d97706] rounded-full animate-pulse" />
                                            <span className="font-semibold text-sm text-[#F8FAF6]">Targeted Map Ready</span>
                                        </div>
                                    </div>
                                </CardContent>
                            </Card>
                            ...
                            <Card className="relative overflow-hidden h-full !bg-white/[0.02] backdrop-blur-3xl !border-white/[0.06] shadow-[inset_0_1px_3px_rgba(255,255,255,0.1),_0_8px_32px_rgba(0,0,0,0.3)] hover:!bg-white/[0.05] hover:!border-white/[0.12] transition-all duration-500 group">
                                <CardContent className="grid h-full pt-8 sm:grid-cols-2 gap-8">
                                    <div className="relative z-10 flex flex-col justify-center space-y-6">
                                        ...
                                        <div className="space-y-3">
                                            <h2 className="text-2xl font-semibold text-[#F8FAF6]">Team Collaboration</h2>
                                            <p className="text-white/60 font-light text-sm leading-relaxed">Export industrial PDF, XLSX, and CSV reports with one click for stakeholders and field teams.</p>
                                        </div>
                                    </div>
                                    <div className="relative border-l border-white/10 pl-6 flex flex-col justify-center gap-6">
                                        <div className="relative flex items-center justify-end gap-3 w-[80%]">
                                            <span className="block h-fit rounded bg-white/5 border border-white/10 px-3 py-1.5 text-xs font-semibold shadow-sm text-white/70">Estate Manager</span>
                                            <div className="size-10 rounded-full ring-2 ring-white/10 shadow-sm bg-[#011712] overflow-hidden">
                                                <img className="size-full object-cover opacity-80 mix-blend-luminosity" src="https://images.unsplash.com/photo-1560250097-0b93528c311a?q=80&w=100&auto=format&fit=crop" alt="Manager" />
                                            </div>
                                        </div>
                                        <div className="relative flex items-center gap-3">
                                            <div className="size-12 rounded-full ring-2 ring-white/10 shadow-sm bg-[#011712] overflow-hidden">
                                                <img className="size-full object-cover opacity-90 mix-blend-luminosity" src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?q=80&w=100&auto=format&fit=crop" alt="Agronomist" />
                                            </div>
                                            <span className="block h-fit rounded bg-[#10b981]/10 border border-[#4ade80]/20 px-3 py-1.5 text-xs font-semibold shadow-sm text-[#4ade80]">Chief Agronomist</span>
                                        </div>
                                        <div className="relative flex items-center justify-end gap-3 w-[60%]">
                                            <span className="block h-fit rounded bg-white/5 border border-white/10 px-3 py-1.5 text-xs font-semibold shadow-sm text-white/70">Field Ops</span>
                                            <div className="size-10 rounded-full ring-2 ring-white/10 shadow-sm bg-[#011712] overflow-hidden">
                                                <img className="size-full object-cover opacity-80 mix-blend-luminosity" src="https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?q=80&w=100&auto=format&fit=crop" alt="Ops" />
                                            </div>
                                        </div>
                                    </div>
                                </CardContent>
